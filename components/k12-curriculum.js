...
g3: {
  ...
  L1:{name:"Short Vowels", gen: classicQuestionPending, image:{ src:"images/Sounds.png", alt:"Short a sound poster with cat, hat, and bat examples" }},
  L2:{name:"Long Vowels", gen: classicQuestionPending},
  L3:{name:"Vowel Sounds", gen: classicQuestionPending},
  L4:{name:"CVC Words", gen: classicQuestionPending},
  L5:{name:"Silent E Words", gen: classicQuestionPending},
  L6:{name:"Vowel Review", gen: classicQuestionPending},

  L7:{name:"Blends", gen: classicQuestionPending},
  L8:{name:"Digraphs", gen: classicQuestionPending},
  L9:{name:"Trigraphs", gen: classicQuestionPending},
  L10:{name:"Beginning Blends", gen: classicQuestionPending},
  L11:{name:"Ending Blends", gen: classicQuestionPending},
  L12:{name:"Blends Review", gen: classicQuestionPending},

  L13:{name:"Variant Vowels", gen: classicQuestionPending},
  L14:{name:"Diphthongs", gen: classicQuestionPending},
  L15:{name:"R-Controlled Vowels", gen: classicQuestionPending},
  L16:{name:"Vowel Patterns", gen: classicQuestionPending},
